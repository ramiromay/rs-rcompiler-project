package com.realssoft.rcompiler.ui.support.notification.ui;
...
import com.realssoft.rcompiler.ui.support.notification.ToastClientProperties;
import com.realssoft.rcompiler.ui.support.notification.util.UIUtils;
...
public class ToastPanelUI extends BasicPanelUI implements StyleableUI, PropertyChangeListener {
    ...
    protected void installDefaults(JPanel p) {
        ...
        closeButtonIcon = UIUtils.getIcon(prefix + ".closeIcon", UIUtils.createIcon("svg/close.svg", closeIconColor, 0.75f));
