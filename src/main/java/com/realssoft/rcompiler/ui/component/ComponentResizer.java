...
public class ComponentResizer extends MouseAdapter
{
    ...
    public void deregisterComponent(Component @NotNull ... components)
    {
    ...
    public void registerComponent(Component @NotNull ... components)
    {
        for (Component component : components)
        {
    ...
    private void validateMinimumAndInsets(@NotNull Dimension minimum, @NotNull Insets drag)
    {
    ...
    public void mousePressed(MouseEvent e)
    {
        ...
        if (direction != 0)
        {
            ...
            if (source instanceof JComponent)
            {
                ...
                isAutoscroll = jc.getAutoscrolls();
    ...
    public void mouseReleased(@NotNull MouseEvent e)
    {
        ...
        if (source instanceof JComponent)
        {
            ((JComponent) source).setAutoscrolls(isAutoscroll);
        }
    }
    ...
    protected void changeBounds(Component source, int direction, @NotNull Rectangle bounds,
                                Point pressed, Point current) {
        ...
        configProperties.setSystemSize(width, height);
        configProperties.setSystemLocation(x, y);
